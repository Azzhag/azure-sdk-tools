...
namespace AzureDeploymentCmdlets.Test.TestData
{
    static class Data
    {
        ...
        private static void InitializeValidStorageServiceData()
        {
            ...
            myStore.StorageServiceProperties.Location = ArgumentConstants.Locations[AzureDeploymentCmdlets.Model.Location.NorthCentralUS];
            ...
            testStore.StorageServiceProperties.Location = ArgumentConstants.Locations[AzureDeploymentCmdlets.Model.Location.EastAsia];
            ...
            MyCompanyStore.StorageServiceProperties.Location = ArgumentConstants.Locations[AzureDeploymentCmdlets.Model.Location.NorthEurope];
